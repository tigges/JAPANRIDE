...
export const officialRoutes: OfficialRoute[] = [
  ...
  },
  {
    ...
    kind: "national",
    note: "National Cycle Route: Himi–Asahi along Toyama Bay. Local sketch for the Toyama episode.",
    path: [
      [36.856, 136.974],
      [36.82, 137.051],
      [36.78, 137.12],
  ...
  },
  {
    ...
    nameJa: "トカプチ400",
    kind: "national",
    note: "National Cycle Route: figure-eight of the Tokachi plain. Local sketch around Obihiro.",
    path: [
      [42.924, 143.196],
      [42.912, 143.051],
      [43.099, 142.99],
  ...
  {
    id: "yamanami",
    name: "Yamanami Highway",
    nameJa: "やまなみハイウェイ",
    kind: "prefectural",
    note: "Prefectural cycling favorite: Beppu–Yufuin–Kuju. Not a National Cycle Route.",
    path: [
      [33.279, 131.501],
      [33.264, 131.355],
      [33.2, 131.3],
